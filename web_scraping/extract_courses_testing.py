...
def main():
    ...
    url_uciuc = "https://siebelschool.illinois.edu/academics/courses"
    url_CalTech = "https://pma.caltech.edu/courses/undergrad/department/CS/2024-25"
    

    
    
    courses = scrape_courses(url_CalTech)
    filename = f"{clean_url(url_CalTech)}_courses.csv"
